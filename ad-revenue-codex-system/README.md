...
第一目標は、広告収入で月20万円以上を狙うことです。ただし広告収益はアクセス数、ジャンル、広告単価、掲載審査、記事品質に大きく左右されます。このパッケージは「毎週記事を増やし、検索流入を測り、改善する」ための土台です。
...
広告RPMが400円の場合、月20万円には約50万PVが必要です。RPMが800円なら約25万PV、RPMが1,500円なら約13.4万PVです。
